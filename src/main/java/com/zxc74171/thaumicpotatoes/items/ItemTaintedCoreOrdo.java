...
public class ItemTaintedCoreOrdo extends Item {
	
	public ItemTaintedCoreOrdo() {
		setMaxDamage(1);
		setMaxStackSize(1);
	}
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		if(!worldIn.isRemote) {
				...
				EntityZiemniak bosso = new EntityZiemniak(worldIn);
				...
				String message = String.format(proxy.translateToLocal("bosstext_ziemniak"));
