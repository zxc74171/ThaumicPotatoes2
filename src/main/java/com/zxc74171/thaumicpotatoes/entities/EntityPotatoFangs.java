...
public class EntityPotatoFangs extends Entity
{
    ...
    public EntityPotatoFangs(World worldIn)
    {
        super(worldIn);
        this.lifeTicks = 22;
    ...
    public EntityPotatoFangs(World worldIn, double x, double y, double z, float p_i47276_8_, int p_i47276_9_, EntityLivingBase casterIn)
    {
        this(worldIn);
    ...
    private void damage(EntityLivingBase p_190551_1_)
    {
        ...
        if (p_190551_1_.isEntityAlive() && !p_190551_1_.getIsInvulnerable() && p_190551_1_ != entitylivingbase)
        {
            ...
            {
                p_190551_1_.attackEntityFrom(PotatoDamageSource.POTATO, 6.0F);
            }
            else
            {
    ...
    public void handleStatusUpdate(byte id)
    {
        ...
        if (id == 4)
        {
            ...
            if (!this.isSilent())
            {
                this.world.playSound(this.posX, this.posY, this.posZ, ModSoundEvents.POE, this.getSoundCategory(), 1.0F, this.rand.nextFloat() * 0.2F + 0.85F, false);
            }
        }
    }
